...
//set dataset equal to selDataset in html file
...
//function to data to the dropdown menu (using onchange in html)
...
function demoInfo(subject) 
{
    d3.json("samples.json").then(function (data) 
    {
        ...
        // clear existing data using empty quotes
        demoInfobox.html("");
...
function buildDash(data, subject, init = false) 
{
    d3.json("samples.json").then(function (data) 
    {
        // use filter to find subject ids
        ...
        otu_ids = otu_ids[0];
        //slice the Ids and map with OTU prefix
        ...
        // sort samples and slice sample values
        ...
        [
            {
                ...
                gauge: 
                {
                    ...
                    bar: {color: "#a64dff"},
                    //set 9 colors for range of outcomes 
                    steps: 
                    [
